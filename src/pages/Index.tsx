...
import { Home, Building2, MapPin, TrendingUp, Hammer, Landmark, Search, Shield, ArrowRight } from "lucide-react";
        ...
        <div className="container py-20">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {[
              ...
              <Link key={area.name} to={`/areas/${area.slug}`}>
                <Card className="group border-primary/20 transition-colors hover:border-primary/40">
