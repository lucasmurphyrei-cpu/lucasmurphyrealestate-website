...
const SavingsSection = ({ rows, derived, onUpdateRow, onAddRow, onRemoveRow }: Props) => (
  <Card>
    <CardHeader>
      <CardTitle className="text-lg font-display">Savings & Investments</CardTitle>
      <p className="text-xs text-muted-foreground">How much you're putting away each month. Rename labels or add/remove rows as needed.</p>
    </CardHeader>
