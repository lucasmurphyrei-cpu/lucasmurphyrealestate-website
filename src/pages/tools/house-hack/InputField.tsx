      ...
      <div className="flex items-center gap-1.5 mb-1.5">
        ...
        {info && (
          <div className="relative" ref={infoRef}>
            ...
            {showInfo && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 rounded-lg border border-border bg-popover p-3 text-xs text-popover-foreground shadow-lg z-50">
